...
const initialPlayers = [
  { id: 1, name: "MOHAMMED", img: `${BASE}1.png` },
  { id: 2, name: "MICHU", img: `${BASE}2.png` },
  { id: 3, name: "JASIR", img: `${BASE}3.png` },
  { id: 4, name: "MUBARAK", img: `${BASE}4.png` },
  { id: 5, name: "SINAN", img: `${BASE}5.png` },
  { id: 6, name: "SHAHAL", img: `${BASE}6.png` },
  { id: 7, name: "SHILU", img: `${BASE}7.png` },
  { id: 8, name: "RICHU", img: `${BASE}8.png` },
  //{ id: 9, name: "ASHIQ", img: `${BASE}9.png` },
  //{ id: 10, name: "AZIK", img: `${BASE}10.png` },
  { id: 11, name: "AACHU", img: `${BASE}11.png` },
  //{ id: 12, name: "AFSWAN", img: `${BASE}12.png` },
  { id: 13, name: "SIDHU", img: `${BASE}13.png` },
  { id: 14, name: "SALAS", img: `${BASE}14.png` },
  { id: 15, name: "MUKTHAR", img: `${BASE}15.png` },
  //{ id: 16, name: "FASAL", img: `${BASE}16.png` },
  { id: 17, name: "RIHAB", img: `${BASE}17.png` },
  { id: 18, name: "MARSOOK", img: `${BASE}18.png` },
  { id: 19, name: "IRFAN", img: `${BASE}19.png` },
  { id: 20, name: "KHALEEL", img: `${BASE}20.png` },
  { id: 21, name: "SHIHAS", img: `${BASE}21.png` },
  { id: 22, name: "NYSAM", img: `${BASE}22.png` },
  { id: 23, name: "ROUF", img: `${BASE}23.png` },
  { id: 24, name: "SHAHALUDHEEN", img: `${BASE}24.png` },
  { id: 25, name: "JALEES", img: `${BASE}25.png` },
  { id: 26, name: "KAMIL", img: `${BASE}26.png` },
